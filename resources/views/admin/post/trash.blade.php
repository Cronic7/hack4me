                     ...
                     <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Trash Post Table</strong>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{route('admin.restore.post',[$post->id])}} " class="d-lg-inline-block">
                                                    @csrf
                                                  
                                                 <button type="submit" class=" btn btn-primary btn-sm d-inline-block">Restore</button>
                                             </form>
