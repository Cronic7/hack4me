@extends('layouts.front.business')
    ...
    <!-- Navbar -->
 @section('header')
         <header class="header text-center text-white" style="background-image: url({{asset('assets/img/business/bg8.jpg')}})">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8 mx-auto">
            ...
            <p class="lead-2 opacity-90 mt-6" style="color: black;"><strong>See the latest blog post of <span class="text-primary" data-typing="@foreach($posts as $post){{$post->title}}, @endforeach" data-back-speed="100"></span></strong></p>
