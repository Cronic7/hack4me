...
@section('header')
  <header class="header text-center text-white" style=" background-color: white;" data-overlay="5">
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p>
             @if($post->user->role=='business')
              
               <img class="avatar avatar-sm" src="{{ asset('profile/business/img/'.Auth::user()->userbusiness->image) }}"  alt="..."></p>
...
<main class="main-content">
      ...
      <div class="section" id="section-content">
        <div class="container">
                ...
                {{$post->description}}
                <hr>
               <center><img src="{{asset('post/img/'.$post->image) }}" height="500" width="500"></center> 
                <hr>
       ...
       <h3>Content</h3>
              ...
              <div class="gap-xy-2 mt-6">
                ...
                <a class="badge badge-pill badge-secondary" href="{{route('business.post.category',$category->id)}}">{{$category->name}}</a>
               @endforeach
              </div>
