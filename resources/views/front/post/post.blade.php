            ...
            <div class="col-md-8 col-xl-9">
              <div class="row gap-y">
               ...
               @forelse($posts as $post)
                <div class="col-md-6">
                  <div class="card card-custome border hover-shadow-6 mb-6 d-block">
                    <a href="{{route('singlepost',$post->id)}}"><img class="card-img-top card-img-top-custome" src="{{asset('post/img/'.$post->image) }}" alt="Card image cap"></a>
          ...
          {{ $posts->appends(['search'=>request()->query('search')])->links()}}
            ...
            <div class="col-md-4 col-xl-3">
              <div class="sidebar px-4 py-md-0">
                ...
                <form class="input-group" action="{{route('post')}}" method="GET">
                ...
                <a class="media text-default align-items-center mb-5" href="{{route('singlepost',$post->id)}}">
