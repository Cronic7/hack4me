          ...
          <div class="col-lg-8 mx-auto align-self-center ">
            ...
            <p>
            	@if($post->user->role=='hacker')
            	 ...
            	 <img class="avatar avatar-sm" src="{{ asset('profile/hacker/img/'.Auth::user()->userhacker->image) }}"  alt="..."></p>
               
                @elseif($post->user->role=='business')
                <img class="avatar avatar-sm" src="{{ asset('profile/hacker/img/'.Auth::user()->userbusiness->image) }}"  alt="..."></p>
